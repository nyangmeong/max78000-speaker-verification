...
/*
  ...
  Hardware: 72,220,672 ops (71,811,072 macc; 296,960 comp; 112,640 add; 0 mul; 0 bitwise)
    ...
    Layer 18 (stage4.add): 20,480 ops (0 macc; 0 comp; 20,480 add; 0 mul; 0 bitwise)
    Layer 19 (stage4.add_relu): 2,641,920 ops (2,621,440 macc; 20,480 comp; 0 add; 0 mul; 0 bitwise)
    Layer 20 (fc_Gemm_8): 28,672 ops (8,192 macc; 0 comp; 20,480 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 335,760 bytes out of 442,368 bytes total (75.9%)
  Bias memory:   1,024 bytes out of 2,048 bytes total (50.0%)
*/
